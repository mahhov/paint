...
export let icons: Record<string, IconInstruction[]> = {
	...
	COLOR_DIFF: [
		...
		{type: IconInstructionType.RECT, coords: [5, 5, 25, 25], color: Color.DARK_GRAY},
		// rectangle 2 (front/offset)
		{type: IconInstructionType.RECT, coords: [8, 8, 28, 28], color: Color.DARK_GRAY},
		// plus sign
		{type: IconInstructionType.LINE, coords: [11, 14, 17, 14], color: Color.DARK_GRAY},
		{type: IconInstructionType.LINE, coords: [14, 10, 14, 17], color: Color.DARK_GRAY},
		// minus sign
		{type: IconInstructionType.LINE, coords: [16, 20, 22, 20], color: Color.DARK_GRAY},
	],
	BUCKET_FILL: [
		// bucket rim
